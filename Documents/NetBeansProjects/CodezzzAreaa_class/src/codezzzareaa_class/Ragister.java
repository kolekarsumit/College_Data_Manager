...
ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter your name Coder :");
        ...
        jLabel2.setText("Enter your age Coder :");
        ...
        jLabel3.setText("Choice your Gender  :");

        jLabel5.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 14)); // NOI18N
        jLabel5.setText("Choice your Coding Platforms :");

        combo2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "C", "CPP", "JAVA", "PYTHONE", "ORACLE" }));
        ...
        combo1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Male", "Female", "other" }));
        ...
        jLabel10.setText("reenter your password :");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon("D:\\Codezzaraaaaa_prj\\monkey-doing-coding-kabic55n6a0wai1i-kabic55n6a0wai1i.jpg")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
			...
			Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","CodeEraa","Code@123");
                        ...
                        String str="insert into New_Coder values(?,?,?,?,?,?,?)";
			...
			PreparedStatement psmt=con.prepareStatement(str);
                        ...
                        String gen;
                        gen=combo1.getSelectedItem().toString();
                        psmt.setString(3, gen);
                        psmt.setInt(4, Integer.parseInt(jTextField3.getText()));
                        String len=combo2.getSelectedItem().toString();
                        psmt.setString(5, len);
                        psmt.setString(6, jTextField4.getText());
                        psmt.setString(7, new String(jPasswordField2.getPassword()));
