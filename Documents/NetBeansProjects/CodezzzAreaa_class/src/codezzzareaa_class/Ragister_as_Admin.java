...
public class Ragister_as_Admin extends javax.swing.JFrame {

   
    public Ragister_as_Admin() {
        initComponents();
    }
Connection Con=null;
Statement st=null;
ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Data of joining : ");
        ...
        jLabel10.setText("Prious institude name : ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ragister_as_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ragister_as_Admin().setVisible(true);
            }
        });
    }
