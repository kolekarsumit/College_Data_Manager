...
public class Ragister_as_Staff extends javax.swing.JFrame {

   
    public Ragister_as_Staff() {
        initComponents();
    }
Connection Con=null;
Statement st=null;
ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("           Choice you Profession :");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Lecturer", "Data Entery", "Labereriyan", "Sport Teacher", " " }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ragister_as_Staff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ragister_as_Staff().setVisible(true);
            }
        });
    }
