...
public class Table_student_ragistration {
   public static void main(String args[]) {
	try {
		...
		smt.executeUpdate("create table New_Coder(name varchar(20),age number,gender varchar(20),phno number(20),code_lang varchar(20),uname varchar(20),pass varchar(20))");
